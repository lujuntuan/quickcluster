...
Item {
    ...
    width: 1920
    height: 720
    property string hmiSetPath: ClusterManager.platformDocPath + "/clusterhmi-ejanus.json"
    property var hmiSet: {
        "id": "clusterhmi",
        "skin": "blue"
    }
    ...
    Image {
        id: backgroundImg
        anchors.fill: parent
        source: ClusterManager.impSkinPath + "/common/menu_bg.png"
        opacity: 1
        visible: opacity > 0
    }
    SingleGauge {
